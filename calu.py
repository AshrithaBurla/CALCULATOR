...
result = Label(root , width = 25 , height = 2 , text="", font=("arial",30), bg="#000000")
result.pack()

Button(root , text = "C" , width = 5 , height =1 , font=("arial" ,30,"bold") , bd=1, fg="#fff" , bg="#fe9037", command = lambda: clear()).place(x=10,y=100)
...
Button(root , text = "0" , width = 10 , height =1 , font=("arial" ,30,"bold") , bd=1, fg="#fff" , bg="#000000", command = lambda: show("0")).place(x=10,y=500)
